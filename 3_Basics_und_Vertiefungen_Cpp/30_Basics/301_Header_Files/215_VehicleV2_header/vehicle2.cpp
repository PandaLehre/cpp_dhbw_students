...
Vehicle::Vehicle(const std::string& name, double position, double avgConsumption)
   : m_name(name), m_position(position), m_avgConsumption(avgConsumption), m_totalConsumption(0.0), m_currentGas(50.0), m_stayAtPosition(false)
{
